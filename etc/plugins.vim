...
let FZF_DEFAULT_COMMAND='[ -n $(command -v apk) ] && find . -maxdepth 10 -type f || find . -maxdepth 10 -type f,l -not -path "*/\.git/*" -not -path "*/\.*/*"'
" let FZF_DEFAULT_COMMAND="find . -maxdepth 10 -type f -not -path \"*/\\.git/*\" -not -path \"*/\\.*/*\""
